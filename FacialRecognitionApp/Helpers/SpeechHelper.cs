...
namespace FacialRecognitionDoor.Helpers
{
    ...
    class SpeechHelper : IDisposable
    {
        ...
        public SpeechHelper(MediaElement media)
        {
            ...
            // TODO: Select the correct voice from device's Operation System
            var list = from a in SpeechSynthesizer.AllVoices
                       where a.Language.Contains("en-US")
                       //where a.Language.Contains("es-ES") // Select spanish voice
                       //where a.Gender == VoiceGender.Female // Select female voice
                       select a;
